...
Seven rules the rooms rely on are said once in-game the first time each bites: **a `?` is a
...
a board creaks either way, the handle is heard too, and a lit shadow hides nobody. They are said on the beat that
