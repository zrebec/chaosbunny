...
const EN: Strings = {
  ...
  carrots: (n) => `CARROT ${n}`,
  beats: (n) => `BEAT ${n}`,
  hints: 'Z EARS X THROW U UNDO C MAP R',
  ...
  roomNames: [
    'THE PANTRY CORRIDOR', 'THE CROSSING', 'THE DARK STEP', 'THE DARK CORRIDOR', 'THE JUNCTION', "THE BAT'S LARDER",
    "THE BAT'S HALL", 'THE SENTRY', 'THE LIT CORNER', 'THE PLANK',
    'THE HANDLE', 'THE LONG WAY ROUND', 'THE WADE', 'THE FORK', 'THE ROOST', 'THE WINDOW',
  ],
...
const SK: Strings = {
  ...
  carrots: (n) => `MRKVA ${n}`,
  beats: (n) => `BEAT ${n}`,
  hints: 'Z USI X HOD U SPAT C MAPA R',
  ...
  roomNames: [
    'SPIZOVA CHODBA', 'PRECHOD', 'KROK V TME', 'TMAVA CHODBA', 'KRIZOVATKA', 'NETOPIERIA KOMORA',
    'NETOPIERIA SIEN', 'STRAZNIK', 'OSVETLENY KUT', 'DOSKA',
    'PAKA', 'OKLUKA', 'BROD', 'RAZCESTIE', 'HNIEZDO', 'OKNO',
  ],
